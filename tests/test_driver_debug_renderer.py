...
def test_render_ui_clip_passes_qcam_to_big_ui_engine(tmp_path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(ui_renderer, "configure_ui_environment", lambda: {"RECORD_CODEC": "libx264"})
    monkeypatch.setattr(ui_renderer, "_configure_ui_recording_encoder", lambda env, _: "cpu")
