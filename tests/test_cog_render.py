...
from cog.render_cog_yaml import render_cog_yaml


def test_render_cog_yaml_embeds_base64_setup_script(tmp_path) -> None:
    ...
    render_cog_yaml(template_path, setup_path, output_path)
